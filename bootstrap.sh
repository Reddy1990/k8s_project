...
apt-get update -y -qq && apt-get install -y -qq apt-transport-https ca-certificates curl software-properties-common nfs-common >/dev/null 2>&1

echo "EXECUTING STEP 2.1 --> NFS Client INSTALLATION (WAIT FOR FEW MINUTES)"
